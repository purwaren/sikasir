...
class Barang extends Model 
{
    ...
    */
    ...
    {
        $query = 'select bm.*,b.nama, b.kelompok_barang, b.harga, b.mutasi_masuk, b.stok_barang from barang_masuk bm left join barang b on bm.id_barang = b.id_barang  where tanggal = "'.$tanggal.'" ';
        return $this->db->query($query);
    }
    /**
